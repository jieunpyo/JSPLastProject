              ...
              <table class="table">
               <tr>
                ...
                <td>
                 ...
                 style="width: 200px" required value="${vo.name }">
               ...
               <tr>
                ...
                <td>
                 ...
                 class="form-control input-sm" id="subject"
               ...
               <tr>
                ...
                <td>
                 <textarea rows="10" cols="50" 
                  class="form-control" name=content required id="content"
                 >${vo.content }</textarea>
                </td>
               </tr>
               <tr>
                ...
                <td>
                 <input type=password name=pwd  id="up_pwd"
                 class="form-control input-sm" style="width: 150px" required>
                </td>
               </tr>
               <tr>
                 <td colspan="2" class="text-center">
                  <input type=button class="btn btn-sm btn-mint" 
                    value="수정" id="updateBtn" style="display:none">
