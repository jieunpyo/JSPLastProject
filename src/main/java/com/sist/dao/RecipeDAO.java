...
public class RecipeDAO {
    ...
    *   <select id="chefListData" resultType="ChefVO"
	  ...
	  >
	    SELECT no,chef,poster,mem_cont1,mem_cont2,mem_cont7,
	    mem_cont3,num
   ...
   public static List<ChefVO> chefListData(Map map)
   {
	   ...
	   List<ChefVO> list=
			   session.selectList("chefListData",map);
	   session.close();
	   return list;
   }
   ...
   public static List<RecipeVO> recipeListData(Map map)
   {
	   SqlSession session=ssf.openSession();
	   List<RecipeVO> list=
			   session.selectList("recipeListData",map);
	   session.close();
	   return list;
   }
  ...
  <select id="recipeFindTotalPage" resultType="int">
   ...
   public static List<RecipeVO> recipeFindData(Map map)
   {
	   SqlSession session=ssf.openSession();
	   List<RecipeVO> list=
			   session.selectList("recipeFindData",map);
	   session.close();
	   return list;
   }
